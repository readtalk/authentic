...
export function Settings({ userId, email }: Props) {
	return (
		<html lang="en">
			<head>
				<meta charset="utf-8" />
			...
			<body>
				...
				<div id="dashboard" style="display:none;">
					<div class="card">
						<h4>Form @username?</h4>
						<div class="info">
							<span class="label">Key ID:</span> <span id="userId">{userId}</span>
						</div>
						<div class="info">
							<span class="label">Email:</span> <span id="email">{email}</span>
						</div>
